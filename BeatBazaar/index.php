...
<body>
  ...
  <!--no tocar-->
       ...
       <!--testeo de algo aun por investigar-->  
        ...
        <div class="col">
          <div class="card shadow-sm">
            <img src="imagenes/productos/11/pastillas.jpg">
        ...
        <div class="col">
          <div class="card shadow-sm">
            <img src="imagenes/productos/12/violinXD.jpg">
        ...
        <div class="col">
          <div class="card shadow-sm">
            <img src="imagenes/productos/13/amplificador.jpg">
        ...
        <div class="col">
          <div class="card shadow-sm">
            <img src="imagenes/productos/15/nirvanacara.jpg">
        ...
        <div class="col">
          <div class="card shadow-sm">
            <img src="imagenes/productos/16/sodaremera.jpg">
        ...
        <div class="col">
          <div class="card shadow-sm">
            <img src="imagenes/productos/17/Mayhem.jpg">
        ...
        <div class="col">
          <div class="card shadow-sm">
            <img src="imagenes/productos/18/micro.jpg">
 ...
 <div class="col">
          <div class="card shadow-sm">
            <img src="imagenes/productos/19/album9.jpg">
         ...
         <div class="col">
          <div class="card shadow-sm">
            <img src="imagenes/productos/20/informorph.jpg">
         ...
         <div class="col">
          <div class="card shadow-sm">
            <img src="imagenes/productos/21/ironmaidenaces.jpg">
         ...
         <div class="col">
          <div class="card shadow-sm">
            <img src="imagenes/productos/22/posterironmaiden.jpg">
